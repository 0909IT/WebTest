...
function troll() {
    ...
    document.getElementById("alert2").innerHTML = "Trang web này chỉ dành riêng cho cậu đó và trái tim tớ cũng vậy..<br> 😛";
    document.getElementById("audio2").play();
    return false;
}
...
function inrel() {
    ...
    c.innerHTML = "";
    c.innerHTML = "Cậu rất giống với con dâu tương lai của ba mẹ tớ <br>❤";
    y.style.display = "none";
    x.style.display = "inline";
    document.getElementById("audio3").play();
    document.getElementById("alert2").innerHTML = "";
    document.getElementById("des").innerHTML = "Cậu cho phép tớ đăng ký hộ khẩu vào tim cậu nha 😳";
	document.getElementById("audio3").play();
    return false;
